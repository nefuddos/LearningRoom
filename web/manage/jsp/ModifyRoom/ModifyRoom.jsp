    ...
    <body>
        ...
        <form action="/LearningRoom/ModifyRoom" method="post">
            <center>
                ...
                学习间大小(m^2)<input type="text" name="size"  value="<%=size%>" /> <br>
                学习间容纳人数(人) <input type="text" name="people"  value="<%=people%>" /> <br>
                学习间描述 <input type="text" name="discri"  value="<%=data[i][3]%>" /> <br>
                管理员联系方式 (电话)<input type="text" name="mnum"  value="<%=data[i][4]%>" /> <br>
