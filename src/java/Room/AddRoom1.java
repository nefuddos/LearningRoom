 ...
 * @author rjg
 */
public class AddRoom1 extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String str="insert into roomtable values ( '"+number+"','"+size+"','"+people+"' , '"+discri+"' , '"+mnum+"')";
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddRoom1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<center>");
             try{
